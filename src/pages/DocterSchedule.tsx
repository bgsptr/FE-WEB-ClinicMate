    ...
    <div className="flex min-h-screen w-full bg-gray-100 font-poppins">
      ...
      <div className="flex-1 px-16 py-8">
        <div className="flex items-center gap-3 mb-[3rem]">
          ...
          <h3 className="font-semibold">Buat Jadwal</h3>
        </div>
                ...
                <form className="mt-9 w-full min-h-screen">
                  ...
                  <div className="w-1/4 mb-8 relative">
                    ...
                    <input
                      ...
                      className="px-4 py-2 border rounded-md w-full"
                    />
                    <div className="absolute right-7 top-9 font-light text-gray-600">slot</div>
                  </div>

                  {/* Submit Button */}
                  <button
                    type="submit"
                    className="mr-3 text-[#478CCF] border-1 bg-white hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                  >
                    Kembali
                  </button>
